...
{ 
             ...
             inputs[0].format == nvinfer1::PluginFormat::kCDHW32)
    {
        ...
        instance_norm_buffer_sizes_dispatch(params, size_sums, size_counts, size_retired_ctas,
    ...
    cudaStream_t stream)
{
             ...
             inputDesc[0].format == nvinfer1::PluginFormat::kCDHW32)
    {
        ...
        size_t size_sums, size_counts, size_retired_ctas;
        instance_norm_buffer_sizes_dispatch(_params, size_sums, size_counts, size_retired_ctas,
                                            input_data_type, output_data_type);
        ...
        _params.gmem_sums = reinterpret_cast<float *>(d_buf); d_buf += size_sums;
        ...
        _params.sm_count = _sm_count;
        _params.in_scale = _in_scale;
        _params.out_scale = 1.f / _out_scale;

        int loop = instance_norm_fwd_dispatch(_params, stream, input_data_type, output_data_type);
    }
    else
    {
    ...
    int pos, const nvinfer1::PluginTensorDesc* inOut, int nbInputs, int nbOutputs)
{
    ...
    bool support_fp16_cdhw32_to_int8_cdhw32 = (pos < nbInputs) ?
        (inOut[pos].type == nvinfer1::DataType::kHALF && inOut[pos].format == nvinfer1::PluginFormat::kCDHW32) :
    ...
    return support_fp32_linear || support_fp16_linear || support_fp16_dhwc8 || support_fp16_cdhw32_to_int8_cdhw32 || support_int8_cdhw32;
}
