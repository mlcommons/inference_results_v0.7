...
arguments_dict = {
    ...
    "action": {
        ...
        "choices": ["generate_engines", "run_harness", "calibrate", "generate_conf_files"],
    },
    "benchmarks": {
...
# Engine generation
PRECISION_ARGS = ["precision", "input_dtype", "input_format"]
CALIBRATION_ARGS = ["verbose", "force_calibration", "calib_batch_size", "calib_max_batches", "cache_file", "calib_data_map", "model_path"]
GENERATE_ENGINE_ARGS = ["dla_core", "gpu_batch_size", "dla_batch_size", "gpu_copy_streams", "workspace_size",
                        "gpu_inference_streams", "verbose_nvtx"] + PRECISION_ARGS + CALIBRATION_ARGS

# Harness framework arguments
LOADGEN_ARGS = ["test_mode", "min_duration", "max_duration", "min_query_count", "max_query_count", "qsl_rng_seed",
    "sample_index_rng_seed", "schedule_rng_seed", "accuracy_log_rng_seed", "logfile_suffix",
...
LWIS_ARGS = ["devices", "gpu_copy_streams", "gpu_inference_streams", "dla_batch_size", "dla_copy_streams",
    "dla_inference_streams", "run_infer_on_copy_streams", "warmup_duration", "use_direct_host_access", "use_deque_limit",
    "deque_timeout_us", "use_batcher_thread_per_device", "use_cuda_thread_per_device", "start_from_device", "max_dlas",
    "coalesced_tensor", "assume_contiguous", "complete_threads"]
TRTIS_ARGS = ["instance_group_count", "preferred_batch_size", "max_queue_delay_usec", "request_timeout_usec"]
SHARED_ARGS = [ "use_graphs", "gpu_batch_size", "map_path", "tensor_path", "performance_sample_count", "mlperf_conf_path", "user_conf_path" ]
OTHER_HARNESS_ARGS = ["log_dir", "use_triton", "use_jemalloc"]
HARNESS_ARGS = ["verbose", "scenario"] + PRECISION_ARGS + LOADGEN_ARGS + LWIS_ARGS + TRTIS_ARGS + SHARED_ARGS + OTHER_HARNESS_ARGS
...
# For code.main
MAIN_ARGS = ["action", "benchmarks", "configs", "config_ver", "scenarios", "no_gpu", "gpu_only", "profile", "no_child_process", "power"]
