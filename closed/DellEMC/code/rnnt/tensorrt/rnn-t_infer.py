...
class EngineRunner():
    ...
    def allocate_buffers(self):
        ...
        if self.engine.has_implicit_batch_dimension : max_batch_size = min(self.engine.max_batch_size, self.args.batch_size)
        else                                        : max_batch_size = self.args.batch_size
            ...
            for seq_id in range(self.hyperP.max_seq_length // 2) :
                ...
                for bs_index in range(actual_batch_size) :
                   ...
                   if new_symbol != self.hyperP.labels_size - 1:
                       ...
                       if ALWAYS_ADVANCE_TIME : enc_ptr[bs_index] += 1
