...
#ifndef PROTOBUF_object_5fdetection_2fprotos_2fbipartite_5fmatcher_2eproto__INCLUDED
#define PROTOBUF_object_5fdetection_2fprotos_2fbipartite_5fmatcher_2eproto__INCLUDED
...
class BipartiteMatcher : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:object_detection.protos.BipartiteMatcher) */ {
 public:
  BipartiteMatcher();
  ...
  void Swap(BipartiteMatcher* other);
  ...
  inline BipartiteMatcher* New() const PROTOBUF_FINAL { return New(NULL); }

  BipartiteMatcher* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct protobuf_object_5fdetection_2fprotos_2fbipartite_5fmatcher_2eproto::TableStruct;
};
// ===================================================================
...
inline void BipartiteMatcher::set_has_use_matmul_gather() {
  _has_bits_[0] |= 0x00000001u;
}
inline void BipartiteMatcher::clear_has_use_matmul_gather() {
  _has_bits_[0] &= ~0x00000001u;
}
...
#endif  // PROTOBUF_object_5fdetection_2fprotos_2fbipartite_5fmatcher_2eproto__INCLUDED
