...
class RunnerBase:
    ...
    def run_one_item(self, qitem):
        ...
        try:
            ...
            processed_results = np.zeros((len(qitem.query_id), 2))
        finally:
            response_array_refs = []
            response = []
...
def main():
    ...
    settings.FromConfig(mlperf_conf, args.model, args.scenario)
    settings.FromConfig(user_conf, args.model, args.scenario)
