...
def generate_measurements_entry(system_name, short_benchmark_name, full_benchmark_name, scenario, flag_dict):
    ...
    generate_system_json(system_json_path, short_benchmark_name)
...
def generate_system_json(system_json_path, short_benchmark_name):
    starting_weights_filename_map = {
        BENCHMARKS.BERT: "bert/bert_large_v1_1.onnx"
    }
