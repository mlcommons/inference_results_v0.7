...
void PostprocessorManager::worker() {
    ...
    while (!destroyed) {
        ...
        // unlock on enqueue
        reshape(103'968, 19, 273, cls0_, k.cls0);
        ...
        reshape( 11'552, 19,  12, box0_, k.box0);
        reshape(  3'200, 10,  24, box1_, k.box1);
        reshape(    800,  5,  24, box2_, k.box2);
        reshape(    288,  3,  24, box3_, k.box3);
        reshape(    128,  2,  24, box4_, k.box4);
        reshape(     32,  1,  24, box5_, k.box5);
