...
public:
    ...
    virtual bool setWeightsName(Weights w, const char* name) noexcept = 0;
...
public:
    ...
    //!
    virtual nvinfer1::IHostMemory* buildSerializedNetwork(INetworkDefinition& network, IBuilderConfig& config) noexcept = 0;
};
