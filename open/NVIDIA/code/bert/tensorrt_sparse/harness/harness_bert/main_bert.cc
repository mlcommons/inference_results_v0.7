...
DEFINE_string(graph_specs, "", "Specify a comma separeated list of (maxSeqLen, BS, totalSeqLen) for CUDA graphs to be captured, will ignore graphs_max_seqlen if specified");
