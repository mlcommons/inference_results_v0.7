...
def generate_measurements_entry(system_name, short_benchmark_name, full_benchmark_name, scenario, input_dtype, flag_dict):
    ...
    generate_system_json(system_json_path, short_benchmark_name, input_dtype)
...
def generate_system_json(system_json_path, short_benchmark_name, input_dtype):
