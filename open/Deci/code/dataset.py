...
def resize_deci(img, out_height, out_width, scale=87.5):
...
def pre_process_deci(img, dims=None, need_transpose=False):
    # FIXME: uncommnet this
    # img = cv2.cvtColor(img, cv2.COLOR_BGR2RGB)
    output_height, output_width, _ = dims
    img = resize_deci(img, output_height, output_width)
