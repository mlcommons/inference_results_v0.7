...
class SSDPostProcess {
 public:
  ...
  //    const std::vector<vitis::ai::library::InputTensor>& input_tensors,
      ...
      const std::vector<vitis::ai::Tensor*>& output_tensors,
   ...
   */
  virtual SSDResult ssd_post_process(std::vector<vitis::ai::TensorBuffer*>& output_tensors, unsigned int idx) = 0;
  /**
   * @brief The batch mode post-processing function of the ssd network.
   * @return The vector of struct of SSDResult.
   */
  virtual std::vector<SSDResult> ssd_post_process(std::vector<vitis::ai::TensorBuffer*>& output_tensors) = 0;
    /**
   * @cond NOCOMMENTS
   */
