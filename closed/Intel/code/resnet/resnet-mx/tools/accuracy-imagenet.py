...
def get_args():
    ...
    parser.add_argument("--output-file", type=str, default="accuracy.txt", help="the file to store the output")
...
def main():
    ...
    msg = "accuracy={:.3f}%, good={}, total={}".format(100. * good / len(seen), good, len(seen))
    print(msg)
