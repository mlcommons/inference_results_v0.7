...
int main(int argc, char **argv) {
    ...
    sut = std::unique_ptr < SUTBase
	    ...
	    void* sut = mlperf::c::ConstructSUT(0, "SUT", 4, issueQueries, flushQueries, processLatencies);
	    void* qsl = mlperf::c::ConstructQSL(0, "QSL", 4, FLAGS_total_sample_count, FLAGS_perf_sample_count, loadQuerySamples, unloadQuerySamples);
    	...
    	void* sut = mlperf::c::ConstructSUT(0, "SUT", 4, issueQueriesOffline, flushQueries, processLatencies);
    	void* qsl = mlperf::c::ConstructQSL(0, "QSL", 4, FLAGS_total_sample_count, FLAGS_perf_sample_count, loadQuerySamples, unloadQuerySamples);
    	...
    	void* sut = mlperf::c::ConstructSUT(0, "SUT", 4, issueQueriesMultistream, flushQueries,  processLatencies);
    	void* qsl = mlperf::c::ConstructQSL(0, "QSL", 4, FLAGS_total_sample_count, FLAGS_perf_sample_count, loadQuerySamples, unloadQuerySamples);
        ...
        void* sut = mlperf::c::ConstructSUT(0, "SUT", 4, issueQueriesServer, flushQueries, processLatencies);
        void* qsl = mlperf::c::ConstructQSL(0, "QSL", 4, FLAGS_total_sample_count, FLAGS_perf_sample_count, loadQuerySamples, unloadQuerySamples);
