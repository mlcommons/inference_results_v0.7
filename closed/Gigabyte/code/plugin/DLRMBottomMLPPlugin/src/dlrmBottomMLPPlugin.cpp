...
\n\
__forceinline__ __device__ int pack(char x, char y, char z, char w) \n\
{ \n\
    int8pack res; \n\
    res.t[0] = x; \n\
    res.t[1] = y; \n\
...
#pragma unroll \n\
        ...
        inputLayer2[fragmentId / 4].x = pack(fastFloatReLUToInt8(intToFloat(acc[0].x, ELEMENT_COUNT_0) * scale1 + biases1.x), \n\
            fastFloatReLUToInt8(intToFloat(acc[0].y, ELEMENT_COUNT_0) * scale1 + biases1.y), \n\
            fastFloatReLUToInt8(intToFloat(acc[1].x, ELEMENT_COUNT_0) * scale1 + biases1.z), \n\
            fastFloatReLUToInt8(intToFloat(acc[1].y, ELEMENT_COUNT_0) * scale1 + biases1.w)); \n\
        inputLayer2[fragmentId / 4].y = pack(fastFloatReLUToInt8(intToFloat(acc[0].z, ELEMENT_COUNT_0) * scale1 + biases1.x), \n\
            fastFloatReLUToInt8(intToFloat(acc[0].w, ELEMENT_COUNT_0) * scale1 + biases1.y), \n\
            fastFloatReLUToInt8(intToFloat(acc[1].z, ELEMENT_COUNT_0) * scale1 + biases1.z), \n\
            fastFloatReLUToInt8(intToFloat(acc[1].w, ELEMENT_COUNT_0) * scale1 + biases1.w)); \n\
        inputLayer2[fragmentId / 4].z = pack(fastFloatReLUToInt8(intToFloat(acc[2].x, ELEMENT_COUNT_0) * scale1 + biases2.x), \n\
            fastFloatReLUToInt8(intToFloat(acc[2].y, ELEMENT_COUNT_0) * scale1 + biases2.y), \n\
            fastFloatReLUToInt8(intToFloat(acc[3].x, ELEMENT_COUNT_0) * scale1 + biases2.z), \n\
            fastFloatReLUToInt8(intToFloat(acc[3].y, ELEMENT_COUNT_0) * scale1 + biases2.w)); \n\
        inputLayer2[fragmentId / 4].w = pack(fastFloatReLUToInt8(intToFloat(acc[2].z, ELEMENT_COUNT_0) * scale1 + biases2.x), \n\
            fastFloatReLUToInt8(intToFloat(acc[2].w, ELEMENT_COUNT_0) * scale1 + biases2.y), \n\
            fastFloatReLUToInt8(intToFloat(acc[3].z, ELEMENT_COUNT_0) * scale1 + biases2.z), \n\
            fastFloatReLUToInt8(intToFloat(acc[3].w, ELEMENT_COUNT_0) * scale1 + biases2.w)); \n\
    } \n\
\n\
...
#pragma unroll \n\
        ...
        inputLayer3[fragmentId / 4].x = pack(fastFloatReLUToInt8(intToFloat(acc[0].x, ELEMENT_COUNT_1) * scale2 + biases1.x), \n\
            fastFloatReLUToInt8(intToFloat(acc[0].y, ELEMENT_COUNT_1) * scale2 + biases1.y), \n\
            fastFloatReLUToInt8(intToFloat(acc[1].x, ELEMENT_COUNT_1) * scale2 + biases1.z), \n\
            fastFloatReLUToInt8(intToFloat(acc[1].y, ELEMENT_COUNT_1) * scale2 + biases1.w)); \n\
        inputLayer3[fragmentId / 4].y = pack(fastFloatReLUToInt8(intToFloat(acc[0].z, ELEMENT_COUNT_1) * scale2 + biases1.x), \n\
            fastFloatReLUToInt8(intToFloat(acc[0].w, ELEMENT_COUNT_1) * scale2 + biases1.y), \n\
            fastFloatReLUToInt8(intToFloat(acc[1].z, ELEMENT_COUNT_1) * scale2 + biases1.z), \n\
            fastFloatReLUToInt8(intToFloat(acc[1].w, ELEMENT_COUNT_1) * scale2 + biases1.w)); \n\
        inputLayer3[fragmentId / 4].z = pack(fastFloatReLUToInt8(intToFloat(acc[2].x, ELEMENT_COUNT_1) * scale2 + biases2.x), \n\
            fastFloatReLUToInt8(intToFloat(acc[2].y, ELEMENT_COUNT_1) * scale2 + biases2.y), \n\
            fastFloatReLUToInt8(intToFloat(acc[3].x, ELEMENT_COUNT_1) * scale2 + biases2.z), \n\
            fastFloatReLUToInt8(intToFloat(acc[3].y, ELEMENT_COUNT_1) * scale2 + biases2.w)); \n\
        inputLayer3[fragmentId / 4].w = pack(fastFloatReLUToInt8(intToFloat(acc[2].z, ELEMENT_COUNT_1) * scale2 + biases2.x), \n\
            fastFloatReLUToInt8(intToFloat(acc[2].w, ELEMENT_COUNT_1) * scale2 + biases2.y), \n\
            fastFloatReLUToInt8(intToFloat(acc[3].z, ELEMENT_COUNT_1) * scale2 + biases2.z), \n\
            fastFloatReLUToInt8(intToFloat(acc[3].w, ELEMENT_COUNT_1) * scale2 + biases2.w)); \n\
    } \n\
\n\
#pragma unroll 4 \n\
...
\n\
        ...
        int outputMerged[2]; \n\
        outputMerged[0] = pack(fastFloatReLUToInt8(intToFloat(acc[0].x, ELEMENT_COUNT_2) * scale3 + biases.x), \n\
            fastFloatReLUToInt8(intToFloat(acc[0].y, ELEMENT_COUNT_2) * scale3 + biases.y), \n\
            fastFloatReLUToInt8(intToFloat(acc[1].x, ELEMENT_COUNT_2) * scale3 + biases.z), \n\
            fastFloatReLUToInt8(intToFloat(acc[1].y, ELEMENT_COUNT_2) * scale3 + biases.w)); \n\
        outputMerged[1] = pack(fastFloatReLUToInt8(intToFloat(acc[0].z, ELEMENT_COUNT_2) * scale3 + biases.x), \n\
            fastFloatReLUToInt8(intToFloat(acc[0].w, ELEMENT_COUNT_2) * scale3 + biases.y), \n\
            fastFloatReLUToInt8(intToFloat(acc[1].z, ELEMENT_COUNT_2) * scale3 + biases.z), \n\
            fastFloatReLUToInt8(intToFloat(acc[1].w, ELEMENT_COUNT_2) * scale3 + biases.w)); \n\
\n\
    ...
    if (!mInitialized)
    {
...

        {
            std::string ptxStr;
            {
                ...
                const char * opts[] = {
                    (capability >= 80) ? "--gpu-architecture=compute_80" : "--gpu-architecture=compute_75",
                    "-std=c++11",
