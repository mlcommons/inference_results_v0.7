...
def get_args():
    ...
    parser.add_argument("--preprocessed_data_dir", default="build/preprocessed_data/brats/brats_reference_preprocessed", help="Path to the directory containing preprocessed data")
    parser.add_argument("--postprocessed_data_dir", default="build/brats_postprocessed_data", help="Path to the directory containing postprocessed data")
    parser.add_argument("--label_data_dir", default="build/preprocessed_data/brats/brats_reference_raw/Task043_BraTS2019/labelsTr",
